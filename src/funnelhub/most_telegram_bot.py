...
BUTTON_REPLIES: dict[str, tuple[str | None, str, list[FunnelButton]]] = {
    ...
    "Я заполнил(а) практику": (
        ...
        "какие внутренние ресурсы у нас есть и почему они могут проседать!",
        [],
    ),
    "Готово": (
    ...
    "Оставить заявку": ("заявка", "Спасибо! Мы свяжемся с вами в ближайшее время!", []),
    "Занять место": ("занять место", "Спасибо! Мы свяжемся с вами в ближайшее время!", []),
    "Не сейчас": (
        "не сейчас",
